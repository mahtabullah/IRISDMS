...
class Challans extends CI_Model {
     ...
     $sql ='SELECT t1.db_id,t4.id,t4.sku_name ,t5.qty As Pack_Size , round(t2.outlet_lifting_price*t5.qty) AS Price,IFNULL(A.TotalQty,0) As totalQty FROM `tbli_db_bundle_price_mapping` as t1
            ...
            left join(
                      ...
                      where t10.planned_order_date="'.$date.'" and t10.db_id='.$db_id.' and t10.psr_id='.$psr_id.'
