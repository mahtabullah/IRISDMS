...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        foreach ($distributor as $key) {
            ...
            $distributor_mobile = $key['distributor_address_id'];
        }
        ?>
        <div class="row"> 
            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php 
                                                ...
                                                ?>
                                        <input type="text" class="form-control integer-input" placeholder="Enter Distributor Mobile Number " id="mobile_no" name="mobile_no" value="<?php echo $mobile1;?>">
                                    </div>
                                </div>                                    
                                <div class="row">
                                    <div class="col-md-6 form-group">
