                    ...
                    <div class="portlet-body form">
                        <form role="form" action="<?php $segments = array('geographical', 'geoGraphicalMasterUpdateById', $id); echo site_url($segments); ?>" method="post">
                            ...
                            <div class="form-actions">
                                ...
                                <a class="btn red" href="<?php echo base_url()?>geographical/geoGraphicalMasterDeleteById/<?php echo $geo_master_id;?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
