                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control input-xlarge select2me" data-placeholder="Select..." id="sku_layer" name="sku_layer" onchange="getParentElement()" required>
                                                <option value=""></option>
                                                <?php
...
//        var sku_layer_id = $("#sku_layer").val();
//        
//         $.ajax({
//            type: "POST",
//            url: "<?php echo base_url(); ?>sku/getParentElement/",
//            data: {sku_layer_id:sku_layer_id},
//            dataType: "json",
//            success: function(data){
//                //$("#unit"+index).append('<option value="" selected="selected">Choose Unit</option>');
//
//                //for (var i = 0; i < data.length; i++) {
//                   // $("#unit"+index).append('<option value="' + data[i].id + '">' + data[i].unit_name + '</option>');
//                //}
//            }
//        });
//    }
