    ...
    <div class="page-content">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control"  placeholder="Enter Product Type Name" name="sku_type_name" id="sku_type_name" required value="<?php echo $sku_type_name;?>">
                            </div>

                            <div class="col-md-6">
                                <label for="sku_type_code">Product Type Code<span style="color: red;">*</span></label>
                                <input type="text" class="form-control" placeholder="Enter Product Type Code" name="sku_type_code" id="sku_type_code" required value="<?php echo $sku_type_code;?>">
				...
				<textarea class="form-control" rows="3" id="sku_type_description" name="sku_type_description"  placeholder="Enter Product Type Description"><?php echo $sku_type_description;?></textarea>
                            </div>
                        </div>
