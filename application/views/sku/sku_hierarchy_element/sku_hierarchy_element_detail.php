                    ...
                    <div class="portlet-body form">
                        <form role="form" name="form" action="<?php $segments = array('sku', 'skuHierarchyElementUpdateById', $id); echo site_url($segments); ?>" method="post" novalidate>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" value="<?php echo $element_name;?>" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="code">Code<span style="color:red;">*</span></label>
                                            <input type="text" class="form-control" id="code" name="code" value="<?php echo $element_code;?>" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="description">Description</label>
                                            <textarea class="form-control" rows="3" id="description" name="description"  placeholder="Description" readonly><?php echo $element_description;?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="sku_layer">Product Layer<span style="color:red;">*</span></label>                                            
                                            <select class="form-control input-xlarge select2me" disabled data-placeholder="Select..." id="sku_layer" name="sku_layer">
                                                <option value=""></option>                                                
                                                <?php 
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control input-xlarge select2me" disabled data-placeholder="Select..." id="parent_element" name="parent_element">
                                                <option value=""></option>
                                                 <?php 
                                                    foreach ($sku_hierarchy_elements as $key) {                                                        
                                                        $selected_owner = ($key['parent_element_id'] == $parent_element_id) ? " selected='selected'" : "";
                                                        echo '<option value="'.$key['id'].'"'.$selected_owner.'>'.$key['element_name'].'</option>';
                            ...
                            <div class="form-actions">
                                <a class="btn red" href="<?php echo base_url()?>sku/skuHierarchyElementDeleteById/<?php echo $element_id;?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
