                            ...
                            <?php $i=1; foreach ($sku_hierarchy_elements as $sku) { ?>
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <button class="btn btn-xs green" onclick="ConfirmationWindow('See Detail',<?php echo '\''.base_url().'sku/skuHierarchyElementDetailtById/'.$sku['sku_hierarchy_element_by_id'].'\''; ?>);" ><i class="fa fa-outdent"></i> Detail </button>                                    
